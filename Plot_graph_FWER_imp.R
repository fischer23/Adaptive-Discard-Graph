...
ggsave("Plot_FWER_ADDIS_Graph_local-u_logq.pdf", width = 7.64, height = 3.59)
...
combined <- p_spending + p_graph  & theme(legend.position = "bottom")
combined + plot_layout(guides = "collect")
ggsave("Plot_FWER_ADDIS_Graph_local-u_q^2.pdf", width = 7.64, height = 3.59)
...
combined <- p_spending + p_graph  & theme(legend.position = "bottom")
combined + plot_layout(guides = "collect")
ggsave("Plot_FWER_ADDIS_Graph_local-u_q^1,6.pdf", width = 7.64, height = 3.59)
