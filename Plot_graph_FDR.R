#Generates Figures 7-9 of the paper "An Adaptive-Discard-Graph for online error control"
...
###Predefine vectors for FDR and power of the different procedures
...
for(k in 1:n){
  if(e[k]>=n){
    ...
    w_adj[k,(e[k]+1):n]=gamma[(e[k]-k+1):(n-k)]/(1-sum(gamma[1:(e[k]-k)]))
  }
}
